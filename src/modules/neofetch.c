...
void neofetch() {
    ...
    print("  (/  /)        "); color1(); print("CPU: i386\n"); color0();
    print(" (___/__)       "); color1(); print("RAM: 512MB\n"); color0(); //Да, я не умею юзать %d
    print("(___/___/)      "); color1(); print("Resolution: "); print(int_to_char(VGA_TERMINAL_WIDTH)); print("x"); print(int_to_char(VGA_TERMINAL_HEIGHT)); print("\n"); color0();
}